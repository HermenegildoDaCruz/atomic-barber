...
export default function PlansAndProgramms() {
  ...
  return (
    <section className="plans-programs container">
      <menu className="menu">
        <li>
          <button className={showPlans ? "menu-btn btn-actived":"menu-btn"} onClick={showPlansView}>Planos</button>
        </li>
        <li>
          <button className={!showPlans ? "menu-btn btn-actived":"menu-btn"} onClick={showProgrammsView}>Programas</button>
        </li>
      </menu>
